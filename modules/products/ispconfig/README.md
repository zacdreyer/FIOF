...
Discover version, node role, server topology, managed services, sites, mail, DNS, databases, cron, firewall, backups, and multiserver dependencies.

## Safety

Use supported ISPConfig interfaces and templates. Treat database and generated configuration edits as high risk. Never assume access to other ISPConfig nodes; remote-node work needs separate authorization and verification.
